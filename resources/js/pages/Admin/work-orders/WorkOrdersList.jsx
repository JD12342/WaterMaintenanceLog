            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="overflow-x-auto">
                            ...
                            {filteredWorkOrders.map(wo => (
                                <tr key={wo.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className={`px-2 py-1 text-xs rounded-full font-medium ${STATUS_BADGES[wo.status] || 'bg-gray-100 text-gray-800'}`}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {wo.estimated_completion_date ? new Date(wo.estimated_completion_date).toLocaleDateString() : '—'}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                                        <button onClick={() => setViewWorkOrder(wo)} className="text-blue-600 hover:text-blue-900">
                    ...
                    {filteredWorkOrders.length === 0 && (
                        <p className="text-center py-8 text-gray-400">No work orders found.</p>
                    )}
                </div>
            </div>
